                            ...
                            <form action="edit-contactus.php?id=<?php echo $id?>" method="POST" class="container">
                                    <div class="row">
                                        <div class="pb-3 col-lg-12">
                                            ...
                                            <input type="text" name="firstname" value="<?php echo $firstname?>" class="" placeholder="Enter your full name">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="pb-3 col-lg-12">
                                            <label for="lastname" class="form-label">Last Name:</label>
                                            <input type="text" name="lastname" value="<?php echo $lastname?>" class="" placeholder="+2547...">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="pb-3 col-lg-12">
                                            <label for="phonenumber" class="form-label">Phone Number:</label>
                                            <input type="text" name="phonenumber" value="<?php echo $phonenumber?>" class="" placeholder="Please enter your email address">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="pb-3 col-lg-12">
                                            <label for="email" class="form-label">Email Address:</label>
                                            <input type="text" name="email" value="<?php echo $emailaddress?>" class="" placeholder="Please enter your email address">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="pb-3 col-lg-12">
                                            <label for="message" class="form-label">Message:</label>
                                            <input type="text" name="message" value="<?php echo $Message?>" class="" placeholder="Please enter your email address">
                                        </div>
                                    </div>
                                    <div class="row">
